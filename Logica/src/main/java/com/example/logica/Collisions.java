...
//Clase equivalente a la clase utils descrita en el enunciado, para el calculo de distancias, intersecciones de segmentos y otras cosas
//Todos sus metodos son estaticos
public class Collisions {
    //Devuelve la distancia de un punto a otro al cuadrado
    ...
    public static Coordenada segmentsIntersection(Segmento s1, Segmento s2) {
        ...
        s1_x = s1.getVert2().get_x() - s1.getVert1().get_x();
        s1_y = s1.getVert2().get_y() - s1.getVert1().get_y();
        s2_x = s2.getVert2().get_x() - s2.getVert1().get_x();
        s2_y = s2.getVert2().get_y() - s2.getVert1().get_y();
    ...
    //Devuelve un vector perpenticular a un segmento dado
